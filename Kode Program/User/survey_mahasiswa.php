...
include_once '../Model/survey_mahasiswa_model.php';

$survey_id = 3;
$surveyMahasiswa = new SurveyMahasiswa($koneksi);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $responden_id = $surveyMahasiswa->insertResponden($responden_data);

    foreach ($_POST['jawaban'] as $soal_id => $jawaban) {
        $jawaban_data = [
            'responden_mahasiswa_id' => $responden_id,
            'soal_id' => $soal_id,
            'jawaban' => $jawaban
        ];
        $surveyMahasiswa->insertJawaban($jawaban_data);
    }
...
$soal_list = $surveyMahasiswa->getSoalBySurveyId($survey_id);
?>
...
<head>
  ...
  <title>Survey Mahasiswa 2024</title>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Survey Mahasiswa 2024</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="alert alert-info">
                  <h4>Survei Kepuasan Mahasiswa terhadap Sistem Pengelolaan yang ada di Politeknik Negeri Malang Tahun 2024</h4>
                  <p>
                    Keterangan penilaian kriteria sebagai berikut:<br>
                ...
                <form method="post" action="">
                  ...
                  foreach ($soal_list as $soal) {
                    if ($soal['kategori_id'] != $current_kategori) {
                      ...
                      $kategori = $surveyMahasiswa->getKategoriById($current_kategori);
                      echo '<div class="card">';
