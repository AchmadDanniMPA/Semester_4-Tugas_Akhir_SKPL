...
include_once '../Model/survey_dosen_model.php';

$survey_id = 1;
$surveyDosen = new SurveyDosen($koneksi);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $responden_id = $surveyDosen->insertResponden($responden_data);

    foreach ($_POST['jawaban'] as $soal_id => $jawaban) {
        $jawaban_data = [
            'responden_dosen_id' => $responden_id,
            'soal_id' => $soal_id,
            'jawaban' => $jawaban
        ];
        $surveyDosen->insertJawaban($jawaban_data);
    }
...
$soal_list = $surveyDosen->getSoalBySurveyId($survey_id);
?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Survey Dosen 2024</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="alert alert-info">
                  <h4>Survei Kepuasan Dosen terhadap Sistem Pengelolaan yang ada di Politeknik Negeri Malang Tahun 2024</h4>
                  <p>
                ...
                <form method="post" action="">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="responden_nip" maxlength="20" required>
                  </div>
                  <div class="form-group">
                  ...
                  foreach ($soal_list as $soal) {
                    if ($soal['kategori_id'] != $current_kategori) {
                      ...
                      $kategori = $surveyDosen->getKategoriById($current_kategori);
                      echo '<div class="card">';
